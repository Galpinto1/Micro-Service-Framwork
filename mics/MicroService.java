...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class, Callback> msgTypeToCallback;
    ...
    public MicroService(String name) {
        ...
        msgTypeToCallback = new ConcurrentHashMap<>();
    }
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        msgTypeToCallback.put(type, callback);
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                Message next = msgBus.awaitMessage(this);
                msgTypeToCallback.get(next.getClass()).call(next);
